          ...
          {loginType === 'user' && (
            <div className="mt-4">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center px-4 py-2 rounded-lg text-sm font-medium bg-section border border-[rgb(var(--c-on-card)/0.04)] hover:shadow-neon-glow disabled:opacity-50 disabled:cursor-not-allowed"
              >
